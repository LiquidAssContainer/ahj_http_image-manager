...
var TO_STRING_TAG_SUPPORT = __webpack_require__(44);
...
var iteratorClose = __webpack_require__(69);
...
var es_array_concat = __webpack_require__(82);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.string.split.js
var es_string_split = __webpack_require__(86);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.regexp.exec.js
var es_regexp_exec = __webpack_require__(59);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.includes.js
var es_array_includes = __webpack_require__(93);
...
var es_array_from = __webpack_require__(108);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.string.iterator.js
var es_string_iterator = __webpack_require__(111);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.symbol.js
var es_symbol = __webpack_require__(116);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.symbol.description.js
var es_symbol_description = __webpack_require__(119);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.symbol.iterator.js
var es_symbol_iterator = __webpack_require__(120);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.iterator.js
var es_array_iterator = __webpack_require__(80);
...
var Fetch = /*#__PURE__*/function () {
  ...
  _createClass(Fetch, null, [{
    key: "createRequest",
    value: function () {
      var _createRequest = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var params,
            responseType,
            options,
            response,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                responseType = _args.length > 1 ? _args[1] : undefined;
                options = _args.length > 2 ? _args[2] : undefined;
                _context.next = 5;
                return fetch(this.url + params, options);
              ...
              case 5:
                ...
                _context.next = _context.t0 === 'text' ? 10 : _context.t0 === 'json' ? 13 : 16;
                break;
...
_defineProperty(Fetch, "url", 'https://ahj-http-image-manager-server.herokuapp.com');


// CONCATENATED MODULE: ./src/js/ImageManager.js
...
function ImageManager_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function ImageManager_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { ImageManager_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { ImageManager_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function ImageManager_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ImageManager_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ImageManager_createClass(Constructor, protoProps, staticProps) { if (protoProps) ImageManager_defineProperties(Constructor.prototype, protoProps); if (staticProps) ImageManager_defineProperties(Constructor, staticProps); return Constructor; }



var ImageManager_ImageManager = /*#__PURE__*/function () {
  function ImageManager() {
    ImageManager_classCallCheck(this, ImageManager);
  ...
  ImageManager_createClass(ImageManager, [{
    key: "insertAllImages",
    value: function () {
      var _insertAllImages = ImageManager_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var imgLinks, _iterator, _step, filename;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Fetch.getImageLinks();

              case 2:
                imgLinks = _context.sent;
                _iterator = _createForOfIteratorHelper(imgLinks);
      ...
      function insertAllImages() {
        return _insertAllImages.apply(this, arguments);
      }
    ...
    value: function insertImage(filename) {
      ...
      img.src = src;
      imgBlock.innerHTML = "\n      ".concat(img.outerHTML, "\n      <button class=\"delete-image\" data-src=\"").concat(src, "\">\xD7</button>\n    ");
    ...
    value: function () {
      var _fileInputChangeHandler = ImageManager_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var files, _files, file, formData, filename;

        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                files = _toConsumableArray(this.fileInput.files);
                ...
                _context2.next = 7;
                return Fetch.postImage(formData);
      ...
      function fileInputChangeHandler() {
        return _fileInputChangeHandler.apply(this, arguments);
      }
    ...
    key: "onDelete",
    value: function () {
      var _onDelete = ImageManager_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(target) {
        var src, paths, filename, response, imgWrapper;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                src = target.previousElementSibling.src;
                paths = src.split('/');
                filename = paths[paths.length - 1];
                _context3.next = 5;
                return Fetch.deleteImage(filename);

              case 5:
                response = _context3.sent;

                if (response.success) {
                  imgWrapper = target.closest('.image_wrapper');
                  imgWrapper.remove();
                } else {
...
var imageManager = new ImageManager_ImageManager();
